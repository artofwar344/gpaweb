...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,sup,sub,|,img,video,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,quote,code,offtop,table,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
	...
	$.wysibb.prototype = {
			...
			if (this.options.onlyBBmode===false) {
				...
				this.$body.bind('keydown', $.proxy(function(e) {
					if ((e.which == 86 && (e.ctrlKey==true || e.metaKey==true)) || (e.which == 45 && (e.shiftKey==true || e.metaKey==true))) {
						if (!this.$pasteBlock) {
							this.saveRange();
							this.$pasteBlock = $(this.elFromString('<div contenteditable="true">\uFEFF</div>'));
		...
		buildToolbar: function() {
			...
			var $bbsw = $(document.createElement('div')).addClass("wysibb-toolbar-container modeSwitch").html('<div class="mswitch" unselectable="on"><span class="btn-inner modesw" unselectable="on"></span></div>').appendTo(this.$toolbar);
