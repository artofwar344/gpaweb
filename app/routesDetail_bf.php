...
//		Route::get('/help/client3', 'Customer\HelpController@client3');
		...
		Route::get('/help/u', 'Customer\HelpController@u');
		Route::get('/help/sp1', 'Customer\HelpController@sp1');
		Route::get('/help/office_error', 'Customer\HelpController@office_error');
		Route::get('/help/activate_error', 'Customer\HelpController@activate_error');
		Route::get('/help/uninstall', 'Customer\HelpController@uninstall');
	...
	'user' => function()
	{
		...
		Route::get('/webserviceauth/validate', 'User\WebserviceauthController@validate');
