...
return array(
	...
	*/
	...
	'cookie' => md5((starts_with(array_get($_SERVER, 'HTTP_HOST'), 'manage') ? 'manage_' : '') . app()->env),
	...
	*/
	...
	'domain' => substr(app()->env, 0, 7) == 'manage.' ?
			null :
			(starts_with(array_get($_SERVER, 'HTTP_HOST'), 'manage') ? 'manage.' : '') . app()->env,
	//'domain' => null,
