...
<div class="product_menu">
	...
	<div class="list">
		...
		<a href="/download/windows10.html" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/win10pro.gif' }})" class="item @if($uri == 'download/windows10.html') hot @endif">
		...
		<a href="/download/windows8_1.html" class="item @if($uri == 'download/windows8_1.html') hot @endif" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/win8.1pro.gif' }})">Windows 8.1 专业版</a>
		@endif
		@if (!in_array('kmsbat', $blockdownloadproducts) && App::make('customer')->alias == 'wxic')
		<a href="/download/kmsbat.html" class="item @if($uri == 'download/kmsbat.html') hot @endif" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/bat.gif' }})">KMS脚本激活</a>
		@endif
		@if (!in_array('macoffice2016', $blockdownloadproducts))
		<a href="/download/macoffice2016.html" class="item @if($uri == 'download/macoffice2016.html') hot @endif" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/macoffice2016pro.gif' }})">微软® Mac Office 2016</a>
		@endif
		@if (!in_array('macoffice', $blockdownloadproducts))
		<a href="/download/macoffice.html" class="item @if($uri == 'download/macoffice.html') hot @endif" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/office2011macpro.gif' }})">微软® Mac Office 2011</a>
		@endif
	</div>
</div>
