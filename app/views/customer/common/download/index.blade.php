...
@if(App::make('customer')->alias == 'wxic' )
<div class="frame_1 main_content product_download" style="width:1000px;">
	<h1 class="header_1">KM激活脚本下载</h1>

	{? $index = 1 ?}
	@if (!in_array('kmsbat', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif" style="width:485px;">
		{? $index++ ?}
		<a href="/download/kmsbat.html"><img width="240px" src="{{ Config::get('app.asset_url') . 'images/customer/common/bat/bat.jpg' }}"></a>
		<h2>KMS脚本激活</h2>
		<ul>
			<li>体积小，安装快</li>
			<li>激活简单，不用登陆</li>
		...
		<a href="/download/kmsbat.html" class="button_2" style="background-color:#0b87bf">Details</a>
	</div>
	@endif
	<div class="clear"></div>
</div>
@endif
@if(App::make('customer')->alias == 'wku' )
<div class="frame_1 main_content product_download" style="width:1000px;">
	<h1 class="header_1">微软英文版应用下载</h1>

	{? $index = 1 ?}
	@if (!in_array('windows8_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif" style="width:485px;">
		{? $index++ ?}
		<a href="/download/windows8_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_1.jpg' }}"></a>
		<h2>Windows 8 Professional</h2>
		<ul>
		...
		<a href="/download/windows8_en.html" class="button_2" style="background-color:#0b87bf">Details</a>
	</div>
	@endif
	@if (!in_array('windows8_1_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif" style="width:485px;">
		{? $index++ ?}
		<a href="/download/windows8_1_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_8.jpg' }}"></a>
		<h2>Windows 8.1 Professional</h2>
		<ul>
			<li>超炫的系统界面，让人一见好心情</li>
			<li>5秒开机，1秒链接无线网！</li>
			<li>速度超快的完美浏览器！</li>
		...
		<a href="/download/windows8_1_en.html" class="button_2" style="background-color:#0b87bf">Details</a>
	</div>
	@endif
	@if (!in_array('windows10_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif" style="width:485px;">
		{? $index++ ?}
		<a href="/download/windows10_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_10.jpg' }}"></a>
		...
		<a href="/download/windows10_en.html" class="button_2" style="background-color:#0b87bf">Details</a>
	</div>
	@endif
	@if (!in_array('windows7_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif" style="width:485px;">
		{? $index++ ?}
		<a href="/download/windows7_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_3.jpg' }}"></a>
		<h2>Windows 7 Professional</h2>
		<ul>
			<li>Multi Touch多点触控</li>
			<li>Aero Shake视窗晃动</li>
			<li>Snap Tool屏幕剪取工具</li>
		...
		<a href="/download/windows7_en.html" class="button_2" style="background-color:#0b87bf">Details</a>
	</div>
	@endif
	@if (!in_array('office2010_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif last" style="width:485px;">
		{? $index++ ?}
		<a href="/download/office2010_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_4.jpg' }}"></a>
		<h2>Office 2010 Professional Plus</h2>
		<ul>
			<li>必备套装办公软件</li>
			<li>更强的视觉效果</li>
			<li>更高效率，简化工作</li>
		...
		<a href="/download/office2010_en.html" class="button_2" style="background-color:#b63e00">Details</a>
	</div>
	@endif
	@if (!in_array('office2013_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif last" style="width:485px;">
		{? $index++ ?}
		<a href="/download/office2013_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_2.jpg' }}"></a>
		<h2>Office 2013 Professional Plus</h2>
		<ul>
			<li>必备套装办公软件</li>
			<li>在云中保存和共享文件</li>
		...
		<a href="/download/office2013_en.html" class="button_2" style="background-color:#b63e00">Details</a>
	</div>
	@endif
	@if (!in_array('office2016_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif last" style="width:485px;">
		{? $index++ ?}
		<a href="/download/office2016_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_2016.jpg' }}"></a>
		<h2>Office 2016 Professional Plus</h2>
		<ul>
			<li>必备套装办公软件</li>
			<li>在云中保存和共享文件</li>
			<li>使用 Office更便捷地工作</li>
		...
		<a href="/download/office2016_en.html" class="button_2" style="background-color:#b63e00">Details</a>
	</div>
	@endif
	
	@if (!in_array('macoffice_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif last" style="width:485px;">
		{? $index++ ?}
		<a href="/download/macoffice_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_6.jpg' }}"></a>
		<h2>Office 2011 for mac  </h2>
		<ul>
			<li>与他人更好地写作</li>
			<li>使用熟知的软件节约时间</li>
			<li>使用专业人士所用的工具</li>
		...
		<a href="/download/macoffice_en.html" class="button_2" style="background-color:#b63e00">Details</a>
	</div>
	@endif
	@if (!in_array('office2016_en', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif last" style="width:485px;">
		{? $index++ ?}
		<a href="/download/macoffice2016_en.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_2016.png' }}"></a>
		...
		<a href="/download/macoffice2016_en.html" class="button_2" style="background-color:#b63e00">Details</a>
	</div>
	@endif
	<div class="clear"></div>
...
@endif
<div class="frame_1 main_content product_download" style="width:1000px;">
	<h1 class="header_1">微软@if(App::make('customer')->alias == 'wku' )中文@endif应用下载</h1>
	...
	@endif
	@if (!in_array('windows8_1', $blockdownloadproducts))
	<div class="product @if ($index%2 == 0) even @endif" style="width:485px;">
		{? $index++ ?}
		<a href="/download/windows8_1.html"><img src="{{ Config::get('app.asset_url') . 'images/customer/common/product_8.jpg' }}"></a>
