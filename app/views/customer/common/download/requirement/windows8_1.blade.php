<h2>Windows 8.1系统要求</h2>
<h3>如果您想要在电脑上运行Windows 8.1, 请在下面查看它所需的配置:</h3>
<ul>
...
<ul>
	...
	<li><a target="_blank" href="http://windows.microsoft.com/zh-CN/windows7/products/features/bitlocker">BitLocker To Go</a>需要 USB 闪存驱动器(只适用于Windows 8.1专业版)</li>
	<li><a target="_blank" href="http://windows.microsoft.com/zh-CN/windows7/products/features/bitlocker">BitLocker</a>需要受信任的平台模块 (TPM) 1.2或USB闪存驱动器(只适用于Windows 8.1专业版)</li>
	<li>Hyper – V客户端要求64位系统与二级地址转换(SLAT)功能和额外的2 GB的RAM(只适用于Windows 8.1专业版)</li>
	<li>若要在<a target="_blank" href="http://windows.microsoft.com/zh-CN/windows7/products/features/windows-media-center">Windows 媒体中心</a>播放和录制直播电视，需要电视调谐器 (只适用于Windows 8.1专业包和Windows 8.1的媒体中心包)</li>
	<li>免费网络电视内容根据地域不同,一些内容可能需要额外的费用(只适用于Windows 8.1 专业包和Windows 8.1的媒体中心包)</li>
</ul>