...
<div class="frame_1 main_content">
	...
	<div class="block_1">
		...
		<img src="{{ Config::get('app.asset_url') . 'images/customer/ccnu/block_1_bg1.jpg' }}">
		@else
		<img src="{{ Config::get('app.asset_url') . 'images/customer/cernet/block_1_bg1.jpg' }}">
		@endif
		<ul>
	...
	<div class="block_1">
		<h1>GP服务体系</h1>
		@if (App::make('customer')->alias == 'ccnu')
		<img src="{{ Config::get('app.asset_url') . 'images/customer/ccnu/block_1_bg2.jpg' }}">
		@else
