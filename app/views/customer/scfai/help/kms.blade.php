<div class="frame_1 main_content">
	...
	<div class="frame_1_r">
		...
		<div class="help_content">
			<p>1) <a href="{{ Config::get('app.asset_url') }}files/Scfai.KMS.bat" class="download">点击这里</a>下载激活脚本</p>
			<p class="img"><img src="{{ Config::get('app.asset_url') . 'images/customer/scfai/help/kms/kms_1.png' }}"/></p>
			<p>2) 右键点击脚本选择“以管理员身份运行”，如图：</p>
			<p class="img"><img src="{{ Config::get('app.asset_url') . 'images/customer/scfai/help/kms/kms_2.png' }}"/></p>
