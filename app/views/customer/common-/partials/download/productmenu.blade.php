...
<div class="product_menu">
	...
	<div class="list">
		...
		<a href="/download/windows10.html" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/win10pro.gif' }})" class="item @if($uri == 'download/windows10.html') hot @endif">Windows 10 专业版</a>
		@endif
		...
		<a href="/download/office2016.html" class="item @if($uri == 'download/office2016.html') hot @endif" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/office2016.gif' }})">Office 2016 专业增强版</a>
		@endif
		...
		<a href="/download/macoffice2016.html" class="item @if($uri == 'download/macoffice2016.html') hot @endif" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/office2016.gif' }})">微软® Mac Office 2016</a>
		@endif
