...
<div class="product_menu">
	<h1>使用帮助</h1>
	<div class="list">
		<a href="/help/faq" style="background-image:url({{ Config::get('app.asset_url') . 'images/customer/common/help/question.png' }})" class="item @if($uri == 'help/faq') hot @endif">常见问题</a>
	</div>
	<div class="list">
