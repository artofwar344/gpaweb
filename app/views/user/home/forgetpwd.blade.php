...
<div class="frame_1">
	<div class="block_1 block_1_account">
		...
		<div class="block_1_l">
			...
			<ul class="information_1 info_success"><li>重置密码邮件已经发送到您的注册邮箱</li></ul>
			@endif

			{{ Form::open(array('url' => '/forgetpwd', 'method' => 'POST', 'id' => 'frmForgetPwd')) }}
			<table class="form_1">
				<tr>
					...
					<td><span class="info"><label class="error">{{ $errors->first("email") }}</label></span></td>
				</tr>
