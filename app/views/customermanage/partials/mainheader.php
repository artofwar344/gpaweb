...
<div class="main_header">
	<a href="/home/welcome" class="logo">
		...
		<img src="<?php echo Config::get('app.asset_url'); ?>images/customer/<?php echo App::make('customer')->alias ?>.jpg" />
		<?php endif; ?>
	</a>
	<div class="version">后台管理 ver: <?php echo Ca\Consts::$ca_version ?></div>
	<div class="user_info">
		<span>账号: <?php echo $currentUser->name ?></span>
		<span>隶属部门: <?php echo \Ca\Service\DepartmentService::getFullName($currentUser->departmentid) ?></span>
