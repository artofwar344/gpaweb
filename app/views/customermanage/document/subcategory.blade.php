<script type="text/javascript">
	$(function() {
		var deleteTip = function(row) {
			return deleteEnable(row) ? "删除该子类别" : "子类别下已经有文档, 无法删除";
		};
		...
		$.backend({
			...
			tableStructure: {
				...
				columns: [
					...
					{ "key": "count", "header": "文档数量", "class": "count", "headertip": "该子类别包含的所有文档数量" }
				]
			},
			category: "子类",
			operators: [
				{ type: "modify", tip: "编辑文档子类别信息", text: "编辑", css: "btn_modify" },
...
@search
array('label' => '名称', 'type' => 'textbox', 'name' => 'name', 'placeholder' => '文档子类别名称')
@endsearch
