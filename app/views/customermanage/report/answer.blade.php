...
$(function() {
	var viewTarget = function(eid) {
		$.post("/reportanswer/gettarget", { "eid": eid }, function(targetid) {
	...
	var disableTarget = function(eid) {
		$.post("/reportanswer/disabletarget", { "eid": eid }, function(ret) {
			backend.list();
		});
		return false;
	};
	...
	var rejectReport = function(eid) {
		$.post("/reportanswer/rejectreport", { "eid": eid }, function(ret) {
			backend.list();
		});
		return false;
	};
	...
	var backend = $.backend({
		...
		category: "举报状态",
		operators: [
			{ type: "callback", callback: rejectReport, enable: dealEnable, tip: "将该回答的举报驳回", text: "驳回举报", css: "btn_auth" },
			{ type: "callback", callback: disableTarget, enable: dealEnable, tip: "将该回答设为禁用状态", text: "禁用回答", css: "btn_delete" },
	...
	$(".multi_actions .button_auth").click(function() {
		...
		$.post("/reportanswer/rejectreportmulti", { eids: backend.checkedRow() }, function() {
	...
	$(".multi_actions .button_disagree").click(function() {
		if ($(this).hasClass("button_1_disabled")) return false;
		$(this).addClass("button_1_disabled");
		$.post("/reportanswer/disabletargetmulti", { eids: backend.checkedRow() }, function() {
			backend.clearCheckedRow();
			backend.list();
		});
		return false;
...
<div class="multi_actions">
	...
	<a href="#" class="button_1 button_1_disabled button_disagree">禁用回答</a>
</div>
