...
<head>
	...
	<link rel="stylesheet" href="{{ Config::get('app.asset_url') }}css/backend.css?{{ Ca\Consts::$ca_version }}"/>
	<link rel="stylesheet" href="{{ Config::get('app.asset_url') }}css/customer.css?{{ Ca\Consts::$ca_version }}"/>
...
<div class="sign_in_wrap">
	<div class="sign_in">
		<div class="logo"></div>
		<h1>管理员登录</h1>
		<span class="customer_logo"><img src="{{ Config::get('app.asset_url') }}images/customer/{{ App::make('customer')->alias }}.jpg" /></span>
